...
void RenderingSystem::EnableDebugLayer() {
#if defined(_DEBUG)
...
void RenderingSystem::AskDescryptorSizes() {
...
void RenderingSystem::CreateHeaps(int textures_amount) {
...
void RenderingSystem::CreateRTV() {
...
void RenderingSystem::CreateZBuffer() {
    //resourse desc
...
void RenderingSystem::ViewportScissorSetup() {
    viewport_ = {};
...
void RenderingSystem::LoadTextureFromTGA(TGAImage& image, UINT textureSlot) {
...
void RenderingSystem::CreateCBV_SRV_Sampler(XMVECTOR cam_pos, XMVECTOR look_at, XMVECTOR up, Model mesh, XMFLOAT3 light_pos) {
    //CBV MVP
    D3D12_HEAP_PROPERTIES heapProps{};
...
void RenderingSystem::CreateRootSignature(int textures_amount) {
    // CBV b0 (MVP) - VS
...
void RenderingSystem::CreateVertexBuffer(Model& model) {
...
void RenderingSystem::Initialize(UINT width, UINT height, int frame_count, Model& mesh, XMVECTOR cam_pos, XMVECTOR look_at, XMVECTOR up, XMFLOAT3 light_pos,
...
void RenderingSystem::RenderFrame(Model& mesh, float time, XMVECTOR cam_pos, XMVECTOR look_at, XMVECTOR up) {
    //Viewport / Scissor
