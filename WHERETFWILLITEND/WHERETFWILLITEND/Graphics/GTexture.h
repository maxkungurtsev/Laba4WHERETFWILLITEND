...
class GTexture{
    ...
    D3D12_RESOURCE_STATES initial_states_[5] = { D3D12_RESOURCE_STATE_COPY_DEST , D3D12_RESOURCE_STATE_COPY_DEST ,D3D12_RESOURCE_STATE_DEPTH_WRITE, D3D12_RESOURCE_STATE_COPY_DEST,D3D12_RESOURCE_STATE_COPY_DEST };
